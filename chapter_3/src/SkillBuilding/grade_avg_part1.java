...
Program: grade_avg_part_1.java          Last Date of this Revision: September 21, 2023

Purpose: An application that calculates the average of 5 grades
...
public class grade_avg_part1 {
	...
	public static void main(String[] args) {
		...
		result = (first + second + third + fourth + fifth)/ 5; // calculate the grade average
